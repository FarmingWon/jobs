...
def main():
    ...
    with st.sidebar:
        ...
        <a href="#how-to-use-balanceup" style="text-align:left; text-decoration:center; color:inherit;"><p>🔔 How To Use</p></a>
        <div id="logo">
            <h5>
                <span>Powered By  &nbsp; &nbsp; &nbsp;</span>
                <img src="data:image/png;base64,{img_to_bytes("./img/openai_logo.PNG")}" style="width:180px; height:60px; background-color:rgba(0,0,0,0.3);">
            </h5>
        </div>
        """
